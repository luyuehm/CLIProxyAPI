...
func orderedMigrations() []databaseMigration {
	return []databaseMigration{
		...
		{version: migrationCreateRouteConfigs, run: addRouteConfigsMigration},
		...
		{version: migrationCreateContentFilterTables, run: createContentFilterTablesMigration},
		{version: migrationCreateCostAllocationTable, run: createCostAllocationMigration},
		{version: migrationSeedModelPrices, run: seedModelPricesMigration},
	}
}
