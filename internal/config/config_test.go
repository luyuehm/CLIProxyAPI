...
var configEnvKeys = []string{
	...
	"AUTH_ENABLED", "LOGIN_PASSWORD", "AUTH_SESSION_TTL", "AUTH_REMEMBER_ME_TTL", "TRUSTED_PROXY_CIDRS", "TZ", "TLS_SKIP_VERIFY", "QUOTA_REFRESH_WORKER_LIMIT", "QUOTA_UPSTREAM_RESPONSES_ENABLED",
